								...
								<div>
									...
									<div class="widget-body">
										...
										<form:form method="POST" modelAttribute="parent" >
											<form:input type="hidden" path="parentId" id="id"/>
											...
											<fieldset>
												...
												<div class="col-sm-6">
														...
														<div class="form-group">
															...
															<div class="input-group">
																<form:input type="text" path="middleName" id="middleName" class="form-control" />
																<span class="input-group-addon"><i class="fa fa-user"></i></span>
																<div class="has-error">
														...
														<div class="form-group">
																...
																<div class="input-group">
																	<form:input type="text" path="fatherName" id="fatherName" class="form-control" />
																	<span class="input-group-addon"><i class="fa fa-chevron-circle-left"></i></span>
																<div class="has-error">
														...
														<div class="form-group">
																...
																<div class="input-group">
																	<form:input type="text" path="motherName" id="motherName" class="form-control" />
																	<span class="input-group-addon"><i class="fa fa-chevron-circle-left"></i></span>
																<div class="has-error">
														...
														<div class="form-group">
																...
																<div class="input-group">
																	<form:input type="text" path="fatherProfession" id="fatherProfession" class="form-control" />
																	<span class="input-group-addon"><i class="fa fa-chevron-circle-left"></i></span>
																<div class="has-error">
																	<form:errors path="fatherProfession" class="help-inline"/>
																</div>
																</div>
														</div>
														<div class="form-group">
																...
																<div class="input-group">
																	<form:input type="text" path="motherProfession" id="motherProfession" class="form-control" />
																	<span class="input-group-addon"><i class="fa fa-chevron-circle-left"></i></span>
																<div class="has-error">
																	<form:errors path="motherProfession" class="help-inline"/>
																</div>
																</div>
														</div>
