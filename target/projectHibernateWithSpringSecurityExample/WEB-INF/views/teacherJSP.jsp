								...
								<div>
									...
									<div class="widget-body">
										...
										<form:form method="POST" modelAttribute="teacher" >
											<form:input type="hidden" path="teacherId" id="id"/>
											...
											<fieldset>
												...
												<div class="col-sm-6">
														...
														<div class="form-group">
																...
																<div class="input-group">
																	<form:input type="text" path="designation" id="designation" class="form-control" />
														...
														<div class="form-group">
															<label>JOD:</label>
															<div class="input-group">
																<form:input type="text" name="jod" id="jod" placeholder="Select a date" path="jod" class="form-control" data-dateformat="dd/mm/yy" />
																<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
															</div>
															<div class="has-error">
