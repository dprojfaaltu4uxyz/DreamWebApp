...
<body class="fixed-page-footer">
			...
			<section id="widget-grid" class="">
				...
				<div class="row">
					...
					<article class="col-sm-12 col-md-12 col-lg-12">
						...
						<!-- Widget ID (each widget will need unique ID) Add to change color - jarviswidget-color-darken-->
							...
							<div>
								...
								<div class="widget-body">
									...
									<form:form method="POST" modelAttribute="classes">
										<form:input type="hidden" path="classesId" id="id" />
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														<label>Class Name (for ex: class one):</label>
														<div class="input-group">
															<form:input type="text" path="classes" id="classes"
																class="form-control" />
													...
													<div class="form-group">
														<label>Note:</label>
														<div class="input-group">
															<form:input type="text" path="note" id="note"
																class="form-control" />
															<span class="input-group-addon"><i
	...
	<script src="<c:url value='/static/js/classes.js' />"></script>
