...
<html lang="en-us">
	...
	<body class="desktop-detected pace-done smart-style-6">
		...
		<!-- HEADER -->
		<%@include file="topPanelJSP.jsp" %>
		<!-- END HEADER -->

		<!-- Left panel : Navigation area -->
		<!-- Note: This width of the aside area can be adjusted through LESS variables -->
		<%@include file="sidePanelJSP.jsp" %>
									...
									<div class="widget-body widget-hide-overflow no-padding">
										...
										<div id="chat-container">
											...
											<div class="chat-list-body custom-scroll">
												<ul id="chat-users">
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/5.png" alt="">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
													</li>
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/male.png" alt="">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
													</li>
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/male.png" alt="">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
													</li>
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/male.png" alt="">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
													</li>
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/male.png" alt="">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
													</li>
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/male.png" alt="">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
													</li>
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/sunny.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
													</li>
													<li>
														<a href="javascript:void(0);"><img src="static/img/avatars/male.png" alt="">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
													</li>
												</ul>
											</div>
		...
		<script>
			if (!window.jQuery) {
				document.write('<script src="<c:url value='/static/js/libs/jquery-2.1.1.min.js' />" ><\/script>');
			}
		</script>
		...
		<script>
			if (!window.jQuery.ui) {
				document.write('<script src="<c:url value='/static/js/libs/jquery-ui-1.10.3.min.js' />" ><\/script>');
			}
		</script>
		...
		<script src="<c:url value='/static/js/plugin/flot/jquery.flot.cust.min.js' />" ></script>
		<script src="<c:url value='/static/js/plugin/flot/jquery.flot.resize.min.js' />" ></script>
		<script src="<c:url value='/static/js/plugin/flot/jquery.flot.time.min.js' />" ></script>
		<script src="<c:url value='/static/js/plugin/flot/jquery.flot.tooltip.min.js' />" ></script>
		
		<!-- Vector Maps Plugin: Vectormap engine, Vectormap language -->
		<script src="<c:url value='/static/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js' />" ></script>
		<script src="<c:url value='/static/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js' />" ></script>
		
		<!-- Full Calendar -->
		<script src="<c:url value='/static/js/plugin/moment/moment.min.js' />" ></script>
		<script src="<c:url value='/static/js/plugin/fullcalendar/jquery.fullcalendar.min.js' />" ></script>
